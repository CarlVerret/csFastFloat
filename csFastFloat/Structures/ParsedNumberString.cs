...
namespace csFastFloat.Structures
{
  internal unsafe struct ParsedNumberString
  {
    ...
    // UTF-16 inputs.
    unsafe static internal ParsedNumberString ParseNumberStringSIMD(char* p, char* pend, NumberStyles expectedFormat = NumberStyles.Float, char decimal_separator = '.')
    {
      ParsedNumberString answer = new ParsedNumberString();
...
unsafe static internal ParsedNumberString ParseNumberStringSIMD3(char* p, char* pend, NumberStyles expectedFormat = NumberStyles.Float, char decimal_separator = '.')
    {
      ParsedNumberString answer = new ParsedNumberString();
